  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "card-gradient": "linear-gradient(135deg, hsl(222 47% 12% / 0.8) 0%, hsl(222 47% 8% / 0.6) 100%)",
        "primary-gradient": "linear-gradient(135deg, hsl(186 100% 50%) 0%, hsl(172 66% 50%) 100%)",
      },
    },
  },
